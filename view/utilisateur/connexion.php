				...
				<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
					<div class="col mx-auto">
						<div class="mb-4 text-center">
							<img src="./page/assets/images/logo-img.png" width="180" alt="" />
						</div>
						<div class="card">
							<div class="card-body">
                          ...
                          <img class="me-2" src="./page/assets/images/icons/search.svg" width="16" alt="Image Description">
                          <!-- <span>Sign in with Google</span> -->
									...
									<div class="form-body">
										<form class="row g-3" action="">
											...
											<div class="col-12">
												<div class="d-grid">
													<a  href="?page=dashboard" class="btn btn-primary"><i class="bx bxs-lock-open"></i>Sign in</a>
												</div>
											</div>
										</form>
									</div>
