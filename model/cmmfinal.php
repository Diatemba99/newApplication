...
class  Cmmfinal {
 ...
 public $secondTrimCorrection;
    ...
    public function saveCmmfinal($idNavire,$x1,$x2,$mad,$y1,$y2,$deplacementMad,$t1,$t2,$lcf,$y1tpc,$y2tcp,$lcfto,$y1tpcmad,$y2tpcmad,$tpcmad,$firstTrimCorrection,$x1secondtrim,$x2secondtrim,$y1secondTrim,$y2secondtrim,$mtc1,$x1secondtrim2,$x2secondtrim2,$y1secondTrim2,$y2secondTrim2,$mtc2,$secondTrimCorrection): bool
    {
    ...
    function getCmmInitialByID($idNavire)
    {
        ...
        if (!is_null($db))
         {
            $sql="SELECT * from cmm_final where id=$idNavire";
            $result=$db->query($sql);
